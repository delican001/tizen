	 ...
	 $(document).ready(function () {
		    $.ajax({
			    ...
			    //	$("#rssContent").append("key: " + field + "<br> значение: " + value[fieldValue] + "<br><br>-------------<br>");
					        $("#rssContent").append('<div class="feed"><div class="image"><img src="' + url + '" width=' + width + 'px /><div class="title"> Title:' + title 
					        		+ '</div><br><div class="description">description: ' + description + '</div><div class="pubDate">pubDate: ' + pubDate + '</div></div>');
			    		}
			    		}),
		        success: xmlParser
		    });
		...
		//  delData(1054);
		    $(xml).find("item").each(function () {
		          ...
		          arr[i] = { title:$(this).find("title").text(), description:$(this).find("description").text(), image: urlToData($(this).find("enclosure").attr('url')),pubDate:$(this).find("pubDate").text()};
